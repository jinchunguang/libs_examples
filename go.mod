module github.com/jinchunguang/demo

go 1.12

require (
	fyne.io/fyne v1.1.1 // indirect
	...
	github.com/henrylee2cn/lessgo v1.0.0 // indirect
	github.com/henrylee2cn/lessgoext v0.0.0-20170109080453-5efdb7c2e58e // indirect
